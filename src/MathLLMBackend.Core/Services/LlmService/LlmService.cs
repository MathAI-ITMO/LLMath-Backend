...
public class LlmService : ILlmService
{
    ...
    public async IAsyncEnumerable<string> GenerateNextMessageStreaming(List<Message> messages, CancellationToken ct)
    {
        ...
        var openaiMessages = ConvertMessagesToOpenAIMessages(messages);
    ...
    private IEnumerable<ChatMessage> ConvertMessagesToOpenAIMessages(List<Message> messages)
    {
        return messages.Select<Message, ChatMessage>(m =>
